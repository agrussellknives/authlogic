        ...
        private
          ...
          def persist_by_cookie
            ...
            if !persistence_token.nil?
              record = record_id.nil? ? search_for_record("find_by_persistence_token", persistence_token) : search_for_record("find_by_#{klass.session_key}", record_id)
          ...
          def save_cookie
            controller.cookies[cookie_key] = {
              :value => "#{record.persistence_token}::#{record.send(klass.session_key)}",
